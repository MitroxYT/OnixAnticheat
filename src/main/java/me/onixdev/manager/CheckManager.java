...
public class CheckManager
{
    ...
    static {
        ...
        CHECKS = new Class[] {AimA.class, AimB.class, AimC.class, BadPacketA.class, BadPacketB.class, BadPacketC.class, NoslowPrediction.class, NoslowTick.class,ScaffoldA.class,

...
public class PacketEntity extends TypedPacketEntity {
    ...
    public PacketEntity(OnixUser player, EntityType type) {
        super(type);
        this.uuid = null;
    ...
    public PacketEntity(OnixUser player, UUID uuid, EntityType type, double x, double y, double z) {
        super(type);
        this.uuid = uuid;
        initAttributes(player);
        this.trackedServerPosition = new TrackedPosition();
    ...
    protected void initAttributes(OnixUser player) {
    ...
    public void onFirstTransaction(boolean relative, boolean hasPos, double relX, double relY, double relZ, OnixUser player) {
        if (hasPos) {
            if (relative) {

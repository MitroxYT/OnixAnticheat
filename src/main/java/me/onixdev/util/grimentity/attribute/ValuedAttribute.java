package me.onixdev.util.grimentity.attribute;
...
public final class ValuedAttribute {
     ...
     */
    public ValuedAttribute requiredVersion(OnixUser player, ClientVersion requiredVersion) {
    ...
    public double with(WrapperPlayServerUpdateAttributes.Property property) {
        ...
        double newValue = MathUtil.clamp((baseValue + additionSum) * (1 + multiplyBaseSum) * multiplyTotalProduct, min, max);
        if (setRewriter != null) {

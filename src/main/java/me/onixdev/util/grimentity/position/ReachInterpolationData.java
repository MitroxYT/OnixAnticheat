package me.onixdev.util.grimentity.position;
...
public class ReachInterpolationData {
    ...
    public ReachInterpolationData(OnixUser player, SimpleCollisionBox finishedLoc, PacketEntity entity) {

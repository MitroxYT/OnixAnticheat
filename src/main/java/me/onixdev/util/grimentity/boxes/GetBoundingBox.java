...
public class GetBoundingBox {
    public static SimpleCollisionBox getCollisionBoxForPlayer(OnixUser player, double centerX, double centerY, double centerZ) {
        if (player.inVehicle()) {
    ...
    public static SimpleCollisionBox getPacketEntityBoundingBox(OnixUser player, double centerX, double minY, double centerZ, PacketEntity entity) {
    ...
    public static SimpleCollisionBox getBoundingBoxFromPosAndSize(OnixUser player, double centerX, double minY, double centerZ, float width, float height) {
    ...
    public static double[] getEntityDimensions(OnixUser player, PacketEntity entity) {
        final float scale = (float) entity.getAttributeValue(Attributes.SCALE);
    ...
    public static void expandBoundingBoxByEntityDimensions(SimpleCollisionBox box, OnixUser player, PacketEntity entity) {

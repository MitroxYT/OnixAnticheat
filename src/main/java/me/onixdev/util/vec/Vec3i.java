...
public class Vec3i implements Comparable<Vec3i> {
    ...
    public boolean closerThan(Vec3i pVector, double pDistance) {
        return this.distSqr(pVector) < MathUtil.square(pDistance);
    }

    public boolean closerToCenterThan(Vec3 pPosition, double pDistance) {
        return this.distToCenterSqr(pPosition) < MathUtil.square(pDistance);
    }
